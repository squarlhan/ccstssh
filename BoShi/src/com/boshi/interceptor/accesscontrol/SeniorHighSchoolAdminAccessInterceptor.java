...
public class SeniorHighSchoolAdminAccessInterceptor implements Interceptor {
	...
	public String intercept(ActionInvocation actionInvocation) throws Exception {
		...
		if (name != null && power != null) {
			if (power.equals("seniorHighSchoolAdminUser") || power.equals("admin")) {
				System.out.println("he is a seniorHighSchoolAdminUser!!!!!!!!!!!!!!");
				return actionInvocation.invoke();
			}
		}
