...
public class DataCenterJuniorCollegeTeachingManageNews extends SuperDateChanging {
	// 教学管理
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeTeachingManageNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeTeachingManageNews.Amount");
