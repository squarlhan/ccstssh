...
public class DataCenterJuniorCollegePolicyAfficheNews extends SuperDateChanging {
	// 大专政策公布
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegePolicyAfficheNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegePolicyAfficheNews.Amount");
