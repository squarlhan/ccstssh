...
public class DataCenterLearningResourceShare extends SuperDateChanging {
	// 学习资源共享
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("LearningResourceShare.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("LearningResourceShare.Amount");
