...
public class DataCenterJuniorCollegeTeachingActivityNews extends SuperDateChanging {
	// 教学活动
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeTeachingActivityNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeTeachingActivityNews.Amount");
