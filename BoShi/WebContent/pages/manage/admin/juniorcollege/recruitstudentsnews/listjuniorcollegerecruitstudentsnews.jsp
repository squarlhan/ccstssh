				...
				<table align="center" width="100%">
					...
					<s:iterator id="result" value="resultList" status="index">		
						<tr bgcolor="<s:if test="#index.odd == true">#ffffff</s:if><s:else>#EDEDED</s:else>">
							...
							<td align="center">
								<a href="<s:url action="ShowJuniorCollegeRecruitStudentsNewsAction"><s:param name="id" value="#result.id"/></s:url>"> <s:property value="#result.title" /> </a>
							</td>
							<td align="center">
								<s:date name="#result.date" format="yyyy年MM月dd日" />
							</td>
							<td align="right"> 
								<a href="<s:url action="ShowJuniorCollegeRecruitStudentsNewsAction!toChange"><s:param name="id" value="#result.id"/></s:url>">修改</a> 
								<a href="<s:url action="ListJuniorCollegeRecruitStudentsNewsAction!remove"><s:param name="id" value="#result.id"/></s:url>"></a>
							</td>
						</tr>
					</s:iterator>
					<tr>
						<td align="center">
							<s:submit action="ListJuniorCollegeRecruitStudentsNewsAction!remove" value="删除所选" />
						</td>
						<td></td>
						<td align="right">
							<a href="<s:url action="ToAddJuniorCollegeRecruitStudentsNewsAction"/>">添加</a>
						</td>
					</tr>
				</table>
			</s:form>
