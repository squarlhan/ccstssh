...
　  		<br/>(b) 危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一的；
	...
	<tr>
		<td align="center">
			<s:form action="GenearchLoginAndRegisterAction!register" validate="true">
				...
				<s:select name="whichClassName" list="theClass" listKey="name" listValue="name" label="您孩子所在班级"/>
				<s:submit value="确定" />
			</s:form>
		</td>
	</tr>
