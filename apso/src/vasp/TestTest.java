		...
		try {
			...
			double lamda = 0.8;
            	for(int bb=0; bb<=0;bb++){
            		apso.Calculate(max_gen, numofparticals, dimention, intertia[0],velocity[0], scopes, new VaspMaxFunction(nn, vol, "AutoPOSCAR"), p_lamda, p_extra,  ap_max, ap_lamda, lamda, output[0]);
            	}
