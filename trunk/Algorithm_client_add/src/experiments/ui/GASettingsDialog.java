 ...
 *
 */
public class GASettingsDialog extends Dialog {
	 ...
	 * @param style
	 */
	public GASettingsDialog(Shell parent, int style) {
		super(parent, style);
	}
	 ...
	 * @param parent
	 */
	public GASettingsDialog(Shell parent) {
	...
	protected void createContents() {
		...
		shell.setText(Messages.getString("GASettingsDialog.0")); //$NON-NLS-1$

		final Label Pc1_label = new Label(shell, SWT.NONE);
		Pc1_label.setText(Messages.getString("GASettingsDialog.1")); //$NON-NLS-1$
		...
		Pm_label.setText(Messages.getString("GASettingsDialog.11")); //$NON-NLS-1$
		...
		K_label.setText(Messages.getString("GASettingsDialog.16")); //$NON-NLS-1$
		...
		Pt_label.setText(Messages.getString("GASettingsDialog.21")); //$NON-NLS-1$
		...
		ok_button.setText(Messages.getString("GASettingsDialog.26")); //$NON-NLS-1$
		...
		cancelbutton.setText(Messages.getString("GASettingsDialog.33")); //$NON-NLS-1$
		...
		N_label.setText(Messages.getString("GASettingsDialog.34")); //$NON-NLS-1$
