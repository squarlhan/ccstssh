...
public void setJobname(String jobname) {
	...
	/**
	   ...
	   * @return
	   */
	public double[][] vector_decoder(double[] data) {
...
//			}
	  ...
	  public double runvasp(double[]  data){
	  	  double result = 0;
	  	  double[][] vecs = vector_decoder(data);
...
public Double[] excute(Matrix data, int nIterateCount) {
	...
	for(int i = 0; i<=m-1; i++){
		...
		results[i] = -1*runvasp(data.data[i]);
	}
	counts += m;
	return results;
}
