...
public class DataCenterJuniorCollegeInviteNews extends SuperDateChanging {
	// 大专招聘新闻
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeInviteNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeInviteNews.Amount");
