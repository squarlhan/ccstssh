...
public class DataCenterSeniorHighSchoolNews extends SuperDateChanging {
	// 高中新闻
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("SeniorHighSchoolNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("SeniorHighSchoolNews.Amount");
