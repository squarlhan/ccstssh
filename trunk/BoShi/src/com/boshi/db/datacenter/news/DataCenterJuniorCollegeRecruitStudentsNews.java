...
public class DataCenterJuniorCollegeRecruitStudentsNews extends SuperDateChanging {
	// 大专招生新闻
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeRecruitStudentsNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeRecruitStudentsNews.Amount");
