...
public class DataCenterJuniorCollegeScientificResearchNews extends SuperDateChanging {
	// 科研成果
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeScientificResearchNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeScientificResearchNews.Amount");
