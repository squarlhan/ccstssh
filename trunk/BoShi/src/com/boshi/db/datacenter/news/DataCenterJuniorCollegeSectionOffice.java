...
public class DataCenterJuniorCollegeSectionOffice extends SuperDateChanging {
	// 大专科室
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeSectionOffice.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeSectionOffice.Amount");
