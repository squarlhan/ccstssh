...
public class DataCenterJuniorCollegeActivityNotifyNews extends SuperDateChanging {
	// 活动通知
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeActivityNotifyNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeActivityNotifyNews.Amount");
