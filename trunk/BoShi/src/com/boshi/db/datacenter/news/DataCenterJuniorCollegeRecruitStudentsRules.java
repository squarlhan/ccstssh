...
public class DataCenterJuniorCollegeRecruitStudentsRules extends SuperDateChanging {
	// 大专招生简章
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeRecruitStudentsRules.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorCollegeRecruitStudentsRules.Amount");
