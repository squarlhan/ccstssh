...
public class DataCenterJuniorHighSchoolRecruitStudentsNews extends SuperDateChanging {
	// 初中招生新闻
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorHighSchoolRecruitStudentsNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorHighSchoolRecruitStudentsNews.Amount");
