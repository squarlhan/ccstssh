...
public class DataCenterJuniorHighSchoolNews extends SuperDateChanging {
	// 初中新闻
	public List<Object> list(int startNO, int howManyOnePage, String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorHighSchoolNews.ListAll");
		return super.list(startNO, howManyOnePage, query);
	}

	public long amount(String param[]) {
		Query query = super.getEntityManager().createNamedQuery("JuniorHighSchoolNews.Amount");
