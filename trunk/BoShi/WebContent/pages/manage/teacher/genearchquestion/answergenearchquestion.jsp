...
<s:form action="AnswerGenearchQuestionAction" validate="true">
	...
	<table align="center">
		<tr>
			<td>
				<s:textarea label="回答" name="answer.aContent" cssStyle="border:1px; width:300px; height:100px;" onmouseover="divShow('必填,最多1000个字符',this);" onmouseout="divHidden();" />
			</td>
		</tr>
		<tr>
			<td>
